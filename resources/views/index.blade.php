            ...
            <div class="col-lg-8 col-lg-offset-2 text-center">
                ...
                <ul class="text-right list-unstyled listP">
                    ...
                    <h4>
                        ...
                        - من الساعة السابعة وحتى الثامنة والنصف ستقام جلسة تحكيمية مع الطلاب الخريجين، وسيجرى التحكيم حسب هذه المعايير: 
                        .فكرة المشروع
                        .جودة المشروع
                        .آلية تنفيذ المشروع
                    </h4>
                    <h4>
                        - يرشح الطلاب الخريجون ١٠ من أصل ٦٠ مشارك يتوجهون لغرفة التحكيم النهائي بتواجدكم و تواجد باقي الحكام، وستتوفر لديكم المعايير والنقاط الممنوحة من قبل الطلاب الخريجين للمتسابقين العشرة.
                    </h4>
                    <h4>
                        - يقوم المتسابقون بعروض سريعة عن برامجهم.
                        - يتم اختيار ٣ فائزين حسب نقاط لجنة التحكيم الأولية والعروض، ويقام بعدها تكريم لهم لاختتام الهاكاثون
                    </h4>
                    <br>
                    <span class="text-500 text-danger">  حضور اليوم الثاني إختياري لمن يريد العمل في مساحة العمل. </span>
                </ul>
            </div>
